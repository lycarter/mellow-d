...
function sentiment2song($text, $sentiment) {
    ...
    $angry = array("crap", "shit", "hate", "fuck", "fail", "damn", "mother", 'hell',
        "mom");
    $angst = array("life sucks", "sucks", "bad grade");
    ...
    $positive = array("terrific", "plus", "bright side", "better");
    $powerful = array("terrib", "horrib", "would end"); // sad
    $pumped = array("i won", "winner", "workout", "good grade", "excit", 'cat ', 'kitten',
    "can't believe it", "cannot believe", "wow", "woo hoo", "ecstatic", "miew", "meow",
...
$sentiment_synonyms = array('romantic' => array('heartbroken :(', 'heartbroken', 'romantic regret', 'lovesick'),
                            ...
                            'joy' => array('joyful', 'exuberant', 'great pleasure'),
                            'angst' => array('a bit angsty', 'angsty', 'some angst'),
                            'love' => array('in love &hearts;', 'wishy-washy love', 'in love', 'romantic', 'affectionate'),
                            'melancholy' => array('melancholic', 'nostalgic', 'pensive', 'reflective', 'lonely', 'depressed')
                            );
$adj = $sentiment;
